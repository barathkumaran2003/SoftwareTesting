          ...
          >
            <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-4 w-full max-w-md">
                  ...
                  {[
                    ...
                    <motion.div
                      ...
                      className="bg-card/90 backdrop-blur rounded-2xl p-6 text-center shadow-card hover:shadow-card-hover transition-shadow"
                    >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 bg-card rounded-2xl p-4 shadow-lg"
              >
